...
#define STRING_CONFIG_H_AUTHOR "(jaydizzz, Ender-5)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5 + MS HOTEND
  #define DEFAULT_Kp 24.74
  #define DEFAULT_Ki 2.46
  #define DEFAULT_Kd 62.32
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.64 }
